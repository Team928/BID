...
const PurchaseBuyer = ({
  ...
  return (
    <div className="relative">
      {subscriber[0] && (
        <div onClick={() => handleMainVideoStream(subscriber[0])}>
          <FullCameraItem streamManager={subscriber[0]} />
        </div>
      )}
      {/* 사진 위 화면 */}
      <div className="absolute top-0 left-0 right-0 bottom-0">
        <div className="w-full h-full relative">
          ...
          <div className="absolute top-24 left-4 right-4 bottom-0 z-[10] flex justify-center items-center">
            <div className="absolute bottom-0 h-20 left-0 right-0 p-3 flex justify-center flex items-center">
              <button
                type="button"
